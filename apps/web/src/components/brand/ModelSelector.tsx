...
export function ModelSelector({ className }: { className?: string }) {
  ...
  const isConfigured =
    ...
    Boolean((customApiKey && customApiKey.trim()) || (customApiBase && customApiBase.trim()));
  const displayLabel = selected?.label || (isConfigured ? "Select Model" : "No Model Configured");
