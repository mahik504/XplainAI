...
export type CanvasTab = "overview" | "evidence" | "graph" | "sources";
...
interface UIState {
  ...
  spotlightEvidenceId: string | null;
  activeGraphMode: "3d" | "2d";
  evidenceFilter: "all" | "supported" | "weakly_supported" | "contradicted" | "unverified";
  ...
  setSpotlightClaimId: (id: string | null) => void;
  setSpotlightSourceId: (id: string | null) => void;
  setSpotlightEvidenceId: (id: string | null) => void;
  setActiveGraphMode: (mode: "3d" | "2d") => void;
  setEvidenceFilter: (filter: "all" | "supported" | "weakly_supported" | "contradicted" | "unverified") => void;
  setSourceSearchQuery: (query: string) => void;
  setSourceFilterType: (type: string) => void;
  toggleSidebar: () => void;
...
export const useUIStore = create<UIState>()((set) => ({
  ...
  setSpotlightClaimId: (id) => {
    set({ spotlightClaimId: id });
  },
  setSpotlightSourceId: (id) => {
    set({ spotlightSourceId: id });
  },
  setSpotlightEvidenceId: (id) => {
    set({ spotlightEvidenceId: id });
  },
  setActiveGraphMode: (mode) => {
    set({ activeGraphMode: mode });
  },
  setEvidenceFilter: (filter) => {
    set({ evidenceFilter: filter });
  },
  setSourceSearchQuery: (query) => {
    set({ sourceSearchQuery: query });
  },
  setSourceFilterType: (type) => {
    set({ sourceFilterType: type });
  },
  toggleSidebar: () => {
