...
from collections.abc import Sequence  # noqa: TC003 - Required for LangGraph runtime get_type_hints
from typing import Any, TypedDict

from neural_navigator.schemas.base import (
    ChatMessage,  # noqa: TC001 - Required for LangGraph runtime get_type_hints
)
